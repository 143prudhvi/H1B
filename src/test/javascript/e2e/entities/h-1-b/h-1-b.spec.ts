...
describe('H1B e2e test', () => {
  ...
  it('should load H1BS', async () => {
    ...
    expect(await h1BComponentsPage.getTitle()).to.eq('h1BApp.h1B.home.title');
  ...
  it('should load create H1B page', async () => {
    ...
    expect(await h1BUpdatePage.getPageTitle()).to.eq('h1BApp.h1B.home.createOrEditLabel');
  ...
  it('should delete last H1B', async () => {
    ...
    expect(await h1BDeleteDialog.getDialogTitle()).to.eq('h1BApp.h1B.delete.question');
